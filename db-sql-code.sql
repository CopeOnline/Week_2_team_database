-- Order matters! Make sure the order of the code is: 
-- 1) create the type at the top, 
-- 2) create the classification table next, 
-- 3) create the inventory table third, and 
-- 4) create the relationship at the bottom.
-- 5) create the account table at the bottom.
-- 6) add data into classification table
-- 7) add data into inventory table
-- 8) update the description for the GM Hummer
-- 9) return all the sport models in inventory
-- 10) replace image and thumbnail paths
